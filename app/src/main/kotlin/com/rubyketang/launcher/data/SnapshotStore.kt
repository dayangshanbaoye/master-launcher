...
data class Snapshot(
    ...
    val proposalDone: Set<String>,
    val proposalRejectedUntil: Map<String, Long>,
...
class SnapshotStore(private val context: Context) {
    ...
    private fun LauncherStateProto.toSnapshot() = Snapshot(
        ...
        proposalDone = proposalDoneList.toSet(),
        proposalRejectedUntil = proposalRejectedUntilMap,
        dndHiddenUntil = dndHiddenUntilMap,
        syncEnabled = syncEnabled,
    )

    private fun TargetProto.toTarget() = Target(
        id = id,
    ...
    private fun Snapshot.toProto(): LauncherStateProto {
        ...
        builder.addAllProposalDone(proposalDone)
        builder.putAllProposalRejectedUntil(proposalRejectedUntil)
